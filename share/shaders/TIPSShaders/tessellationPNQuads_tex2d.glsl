...
void main() {
	...
	tcdata[I].texcoord2 = vdata[I].texcoord2;
...
void main() {
	...
	//Texture2D coords
	vec2 t0 = tcdata[0].texcoord2;
	vec2 t1 = tcdata[1].texcoord2;
	vec2 t2 = tcdata[2].texcoord2;
	vec2 t3 = tcdata[3].texcoord2;
	...
	tedata.texcoord2 = tu0*(tv0*t0 + tv1*t1)
                   + tu1*(tv0*t3 + tv1*t2);
