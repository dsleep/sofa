...
NewOmniDriver::NewOmniDriver()
    ...
    , openSpeedTool(initData(&openSpeedTool,0.06,"openSpeedTool","openSpeedTool value"))
    , closeSpeedTool(initData(&closeSpeedTool,0.06,"closeSpeedTool","closeSpeedTool value"))
